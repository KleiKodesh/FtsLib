...
class SnippetPipeline {
  ...
  static SnippetResult generate(
    ...
    final innerResult =
        _getBuilder(snippetLength, contextWords).buildFromGroups(
      content,
      queryGroups,
      requireOrdered: requireOrdered,
      originalGroupCount: originalGroupCount,
    );
    return SnippetResult(innerResult.html, innerResult.score,
        innerResult.wordDistance, innerResult.isMatch);
  }
  ...
  static SnippetResult generateFromTerms(
    ...
    final innerResult = _getBuilder(snippetLength, contextWords)
        .buildFromTerms(content, queryTerms);
    return SnippetResult(innerResult.html, innerResult.score,
        innerResult.wordDistance, innerResult.isMatch);
  }
